...
[data-testid="stHeader"]{background:transparent}.main .block-container{max-width:1460px;padding:1.5rem 2.1rem 4rem}
...
.mp-title{font-family:Georgia,"Times New Roman",serif;font-size:2.75rem;font-weight:600;letter-spacing:-.035em;color:var(--ink)}.mp-sub{margin:.45rem 0 1rem 3.2rem;color:var(--muted);font-size:.72rem;letter-spacing:.18em;text-transform:uppercase}
.mp-rule{height:1px;background:linear-gradient(90deg,var(--gold),transparent 70%);opacity:.55;margin:.3rem 0 1rem}.mp-meta{display:flex;gap:.7rem;align-items:center;flex-wrap:wrap;margin-bottom:.7rem}
.mp-status{display:inline-flex;align-items:center;gap:.42rem;padding:.3rem .65rem;border:1px solid var(--line);border-radius:999px;font-size:.67rem;letter-spacing:.11em;text-transform:uppercase;color:var(--ink)}
.mp-dot{width:7px;height:7px;border-radius:50%;background:var(--green);box-shadow:0 0 10px rgba(89,185,135,.65)}.mp-dot.closed{background:#707985;box-shadow:none}.mp-clock{font-size:.73rem;color:var(--muted)}
.mp-wire{font-size:.66rem;letter-spacing:.16em;text-transform:uppercase;color:var(--muted);margin-top:.85rem}.mp-ticker{overflow:hidden;border:1px solid var(--line);border-radius:12px;background:linear-gradient(90deg,rgba(201,168,91,.06),rgba(255,255,255,.018));padding:9px 0;box-shadow:var(--shadow)}
.mp-track{display:inline-block;white-space:nowrap;padding-left:100%;animation:mp-scroll 180s linear infinite;font-size:.82rem;color:var(--ink)}.mp-track:hover{animation-play-state:paused}.mp-news-item{display:inline-block;margin-right:30px}.mp-news-item small{color:var(--muted)}
@keyframes mp-scroll{from{transform:translateX(0)}to{transform:translateX(-100%)}}
.mp-card,.dc-card{background:linear-gradient(180deg,rgba(255,255,255,.032),rgba(255,255,255,.018));border:1px solid var(--line);border-radius:17px;padding:1rem;box-shadow:0 9px 28px rgba(0,0,0,.14)}
.mp-kicker,.dc-label{font-size:.62rem;letter-spacing:.14em;text-transform:uppercase;color:var(--muted)}.mp-price{font-family:Georgia,"Times New Roman",serif;font-size:1.55rem;color:var(--ink);margin:.25rem 0 .15rem}.mp-change{font-size:.75rem;color:var(--muted)}
.mp-section,.dc-section{font-family:Georgia,"Times New Roman",serif;color:var(--ink);font-size:1.55rem;margin:1.55rem 0 .7rem}.mp-hero{background:linear-gradient(135deg,rgba(201,168,91,.11),rgba(255,255,255,.015) 42%,rgba(99,130,159,.06));border:1px solid var(--line);border-radius:22px;padding:1.2rem;box-shadow:var(--shadow)}
.mp-eyebrow{font-size:.65rem;letter-spacing:.16em;text-transform:uppercase;color:var(--gold)}.mp-big{font-family:Georgia,"Times New Roman",serif;font-size:2rem;color:var(--ink);line-height:1.1;margin:.35rem 0 .45rem}.mp-muted{color:var(--muted);font-size:.8rem;line-height:1.5}
.mp-chip{display:inline-flex;padding:.25rem .55rem;border-radius:999px;border:1px solid var(--line);font-size:.68rem;color:var(--muted);margin:.35rem .3rem 0 0}.mp-scenario{border:1px solid var(--line);border-radius:15px;background:rgba(255,255,255,.018);padding:1rem;min-height:145px}.mp-scenario h4,.dc-case h4{font-family:Georgia,"Times New Roman",serif;color:var(--ink)}.mp-scenario p,.dc-case p{color:#c5cbd3;line-height:1.5;font-size:.82rem}
.dc-title{font-family:Georgia,"Times New Roman",serif;font-size:2.55rem;color:var(--ink);font-weight:600}.dc-sub{color:var(--muted);font-size:.82rem;margin:.35rem 0 1.2rem}.dc-score{font-family:Georgia,"Times New Roman",serif;font-size:4.8rem;line-height:1;color:var(--ink)}.dc-scorebar{height:10px;border-radius:999px;background:linear-gradient(90deg,#a44f49 0%,#a44f49 35%,#9a7b35 35%,#9a7b35 65%,#2f6f52 65%,#2f6f52 100%);overflow:hidden}.dc-marker{height:100%;width:3px;background:#f5f1e8}.dc-case{min-height:150px}.dc-bull{border-top:2px solid #2f6f52}.dc-base{border-top:2px solid #9a7b35}.dc-bear{border-top:2px solid #a44f49}.dc-foot{border-top:1px solid var(--line);margin-top:2rem;padding-top:.8rem;color:#687280;font-size:.68rem;text-align:center}
.news-summary{display:grid;grid-template-columns:repeat(3,1fr);gap:.75rem;margin:.9rem 0 1.1rem}.news-stat{border:1px solid var(--line);border-radius:14px;padding:.8rem 1rem;background:rgba(255,255,255,.018)}.news-stat-label{font-size:.6rem;letter-spacing:.13em;text-transform:uppercase;color:var(--muted)}.news-stat-value{font-family:Georgia,serif;font-size:1.45rem;color:var(--ink);margin-top:.15rem}.news-evidence{border:1px solid var(--line);border-radius:16px;background:rgba(255,255,255,.018);padding:1rem;margin-top:.85rem}.news-evidence-title{font-size:.63rem;letter-spacing:.14em;text-transform:uppercase;color:var(--gold)}.news-evidence-head{font-family:Georgia,serif;color:var(--ink);font-size:1.05rem;margin:.3rem 0}.news-evidence-meta{font-size:.75rem;color:var(--muted);line-height:1.6}.news-score{font-family:Georgia,serif;font-size:2rem;color:var(--ink)}
...
@media(max-width:900px){.main .block-container{padding:1rem .9rem 3rem}.mp-title{font-size:2.15rem}.mp-sub{margin-left:2.8rem;font-size:.61rem}.mp-big{font-size:1.65rem}.mp-section,.dc-section{font-size:1.35rem}.dc-title{font-size:2.1rem}.news-summary{grid-template-columns:1fr}}
</style>
...
if news_intel:
    ...
    for item in news_intel[:12]:
        score=item.get("evidence_score",10); parts.append(f'<span class="mp-news-item"><b>{verification_badge(item.get("verification"))}</b> {html.escape(item.get("title",""))} <small>• {html.escape(item.get("publisher","Unknown publisher"))} • Evidence {score}/100 • {html.escape(item.get("impact","NEUTRAL"))}</small></span>')
...
with decision:
    ...
    with a:
        st.markdown('<div class="dc-card">',unsafe_allow_html=True); st.markdown('<div class="dc-label">Day setup score</div>',unsafe_allow_html=True); st.markdown(f'<div class="dc-score">{score}<span style="font-size:1rem;color:#7d8790"> / 100</span></div>',unsafe_allow_html=True); st.markdown(f'<div style="font-weight:700;margin:.35rem 0 .7rem">{html.escape(bias)}</div>',unsafe_allow_html=True); st.markdown(f'<div class="dc-scorebar"><div style="margin-left:{score}%;height:100%;position:relative"><div class="dc-marker"></div></div></div>',unsafe_allow_html=True); st.markdown(f'<div style="margin-top:.7rem;color:#c5cbd3;font-size:.78rem">Regime · {html.escape(regime)}<br>Confidence · {html.escape(confidence)}</div>',unsafe_allow_html=True); st.markdown('</div>',unsafe_allow_html=True)
    with b:
        c1,c2,c3=st.columns(3); c1.metric("AI bias",ai.get("bias","WAIT")); c2.metric("AI confidence",ai.get("confidence","N/A")); c3.metric("Rule bias",report.get("verdict","WAIT")); st.markdown('<div class="dc-card" style="margin-top:.9rem">',unsafe_allow_html=True); st.markdown('<div class="dc-label">Core thesis</div>',unsafe_allow_html=True); st.markdown(f'<div style="font-family:Georgia,serif;font-size:1.1rem;line-height:1.5;color:#f2eee5;margin-top:.35rem">{html.escape(ai.get("thesis") or report.get("summary") or "No thesis available yet.")}</div>',unsafe_allow_html=True); st.markdown('</div>',unsafe_allow_html=True)
...
with news_tab:
    ...
    if news_intel:
        checked=[x for x in news_intel if "evidence_score" in x]; scores=[int(x.get("evidence_score",10)) for x in checked]
        avg_score=round(sum(scores)/len(scores)) if scores else 0; strong=sum(s>=75 for s in scores); conflicts=sum(x.get("verification")=="CONFLICTING" for x in checked)
        st.markdown(f'<div class="news-summary"><div class="news-stat"><div class="news-stat-label">Avg evidence strength</div><div class="news-stat-value">{avg_score}/100</div></div><div class="news-stat"><div class="news-stat-label">Strong evidence stories</div><div class="news-stat-value">{strong}</div></div><div class="news-stat"><div class="news-stat-label">Conflicting stories</div><div class="news-stat-value">{conflicts}</div></div></div>',unsafe_allow_html=True)
        rows=[]
