...
def render_sidebar():
    ...
    /* The mover-card div is emitted by one Streamlit element, while rows/links are emitted by later elements.
       Put the actual border on the containing Streamlit column so the whole mover table is enclosed. */
